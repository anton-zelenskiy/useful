...
# {(agency_id, provider_db_name, report_type, metrics): safe_for_migration}
TEST_ALL = {
    (3710, 'getintent', 'creatives', ["clicks", "unique_imps", "spent", "impression"]): False,
    (1570, 'getintent', 'creatives', ["clicks", "unique_imps", "spent", "impression"]): False,
    (1, 'getintent', 'creatives', ["clicks", "unique_imps", "spent", "impression"]): True,
    (3256, 'getintent', 'creatives', ["clicks", "unique_imps", "spent", "impression"]): True,
    (3710, 'adriver', 'banners', ["impression","creative_view","start","midpoint","first_quartile","third_quartile","complete","mute","unmute","pause","click","exp"]): False,
    (102, 'apple_search', 'adsets', ["conv","imps","taps","spend"]): True,
    (3202, 'apple_search', 'adsets', ["conv","imps","taps","spend"]): False,
    (3202, 'apple_search', 'keywords', ["conv","imps","taps","cpt_bid","spend"]): False,
    (3202, 'apple_search', 'searchterms', ["conv","imps","taps","spend"]): True,
    (3749, 'apple_search', 'keywords', ["conv","imps","taps","cpt_bid","spend"]): False,
    (3749, 'apple_search', 'adsets', ["conv","imps","taps","spend"]): False,
    (3749, 'apple_search', 'searchterms', ["conv","imps","taps","spend"]): False,
    (5717, 'apple_search', 'adsets_geo', ["imps","conv","spend","taps"]): True,
    (3660, 'apple_search', 'adsets', ["conv","imps","taps","spend"]): False,
    (3937, 'apple_search', 'keywords', ["conv","imps","taps","cpt_bid","spend"]): True,
    (3937, 'apple_search', 'adsets_device', ["imps","conv","spend","taps"]): True,
    (3937, 'apple_search', 'adsets', ["conv","imps","taps","spend"]): True,
    (3937, 'apple_search', 'adsets_geo', ["imps","conv","spend","taps"]): True,
    (3842, 'apple_search', 'searchterms', ["conv","imps","taps","spend"]): True,
    (3842, 'apple_search', 'adsets', ["conv","imps","taps","spend"]): True,
    (3842, 'apple_search', 'keywords', ["conv","imps","taps","cpt_bid","spend"]): True,
    (5571, 'apple_search', 'adsets_geo', ["imps","conv","spend","taps"]): True,
    (5571, 'apple_search', 'adsets', ["conv","imps","taps","spend"]): True,
    (5571, 'apple_search', 'adsets_device', ["imps","conv","spend","taps"]): True,
    (5571, 'apple_search', 'searchterms', ["conv","imps","taps","spend"]): True,
    (5571, 'apple_search', 'keywords', ["conv","imps","taps","cpt_bid","spend"]): True,
    (1, 'apple_search', 'adsets', ["conv","imps","taps","spend"]): True,
    (4424, 'apple_search', 'adsets', ["conv","imps","taps","spend"]): True,
    (4424, 'apple_search', 'adsets_device', ["imps","conv","spend","taps"]): True,
    (4424, 'apple_search', 'adsets_geo', ["imps","conv","spend","taps"]): True,
    (4546, 'apple_search', 'adsets_geo', ["imps","conv","spend","taps"]): True,
    (4546, 'apple_search', 'searchterms', ["conv","imps","taps","spend"]): True,
    (4424, 'apple_search', 'keywords', ["conv","imps","taps","cpt_bid","spend"]): True,
    (4994, 'apple_search', 'adsets', ["conv","imps","taps","spend"]): True,
    (4994, 'apple_search', 'keywords', ["conv","imps","taps","cpt_bid","spend"]): True,
    (1623, 'apple_search', 'adsets', ["conv","imps","taps","spend"]): True,
    (1623, 'apple_search', 'keywords', ["conv","imps","taps","cpt_bid","spend"]): True,
    (102, 'apple_search', 'keywords', ["conv","imps","taps","cpt_bid","spend"]): True,
    (5571, 'awin', 'creatives', ["bonus_comm","bonus_no","bonus_value","clicks","confirmed_comm","confirmed_no","confirmed_value","declined_comm","declined_no","declined_value","impressions","pending_comm","pending_no","pending_value","total_comm","total_no","total_value"]): True,
    (5571, 'awin', 'publisher', ["impressions","clicks","pending_no","pending_value","pending_comm","confirmed_no","confirmed_value","confirmed_comm","bonus_no","bonus_value","bonus_comm","total_no","total_value","total_comm","declined_no","declined_value","declined_comm"]): True,
    (5571, 'awin', 'transactions', ["commission_amount","sale_amount"]): True,
    (3675, 'getcake', 'conversions', ["price"]): True,
    (3675, 'getcake', 'sub_affiliate', ["clicks","conversions","events","impressions","lite_clicks","revenue","total_lite_clicks"]): True,
    (3675, 'getcake', 'campaign', ["impressions","clicks","conversions","revenue","events","price","lite_clicks","total_lite_clicks"]): True,
    (1, 'getcake', 'campaign', ["impressions","clicks","conversions","revenue","events","price","lite_clicks","total_lite_clicks"]): True,
    (1, 'getcake', 'sub_affiliate', ["clicks","conversions","events","impressions","lite_clicks","revenue","total_lite_clicks"]): True,
    (1, 'getcake', 'conversions', ["price"]): True,
    (3202, 'branch_tune', 'sub_sites_devices', ["installs","conv","visits","events","enrollments","payouts","revenues_usd"]): True,
    (3202, 'branch_tune', 'sub_sites_my_campaign', ["installs","conv","visits","events","enrollments","payouts","revenues_usd","gross_clicks"]): True,
    (3202, 'branch_tune', 'keywords', ["installs","conv","visits","events","enrollments"]): True,
    (3202, 'branch_tune', 'campaign', ["installs","events","payouts","revenues_usd","ad_clicks","ad_clicks_unique","ad_impressions","ad_impressions_unique","opens","purchase","updates"]): True,
    (3202, 'branch_tune', 'sub_sites_campaign', ["installs","conv","visits","events","enrollments","payouts","revenues_usd"]): True,
    (1623, 'branch_tune', 'sub_sites_devices', ["installs","conv","visits","events","enrollments","payouts","revenues_usd"]): True,
    (1623, 'branch_tune', 'campaign', ["installs","events","payouts","revenues_usd","ad_clicks","ad_clicks_unique","ad_impressions","ad_impressions_unique","opens","purchase","updates"]): True,
    (1623, 'branch_tune', 'sub_sites_my_campaign', ["installs","conv","visits","events","enrollments","payouts","revenues_usd","gross_clicks"]): True,
    (1623, 'branch_tune', 'keywords', ["installs","conv","visits","events","enrollments"]): True,
    (1623, 'branch_tune', 'sub_sites_campaign', ["installs","conv","visits","events","enrollments","payouts","revenues_usd"]): True,
    (102, 'branch_tune', 'campaign', ["installs","events","payouts","revenues_usd","ad_clicks","ad_clicks_unique","ad_impressions","ad_impressions_unique","opens","purchase","updates"]): True,
    (102, 'branch_tune', 'keywords', ["installs","conv","visits","events","enrollments"]): True,
    (102, 'branch_tune', 'sub_sites_campaign', ["installs","conv","visits","events","enrollments","payouts","revenues_usd"]): True,
    (102, 'branch_tune', 'sub_sites_devices', ["installs","conv","visits","events","enrollments","payouts","revenues_usd"]): True,
    (102, 'branch_tune', 'sub_sites_my_campaign', ["installs","conv","visits","events","enrollments","payouts","revenues_usd","gross_clicks"]): True,
    (5710, 'eventbrite_sales', 'eventbrite_sales', ["total_tickets_amount","quantity_of_sold_tickets"]): True,
    (5629, 'eventbrite_sales', 'eventbrite_sales', ["total_tickets_amount","quantity_of_sold_tickets"]): True,
    (3927, 'eventbrite_sales', 'eventbrite_sales', ["total_tickets_amount","quantity_of_sold_tickets"]): True,
    (1, 'eventbrite_sales', 'eventbrite_sales', ["total_tickets_amount","quantity_of_sold_tickets"]): True,
    (3916, 'act_on', 'message_report', ["sent","delivered","bounced","hard_bounced","soft_bounced","notopened","optout","last_open","last_clicks","last_open_ts","rebroad_cast","rebroad_cast_click","clicked","unuqie_clicked","opened","unique_opened","effective_opened","unique_effective_opened","notsent","unique_notsent"]): True,
    (3916, 'act_on', 'optout_list', []): True,
    (3916, 'act_on', 'daily_message', ["opted_out","sent","bounced","clicked","opened"]): True,
    (3916, 'act_on', 'spam_complaint_list', []): True,
    (3916, 'act_on', 'message_drilldown', []): True,
    (3916, 'act_on', 'message_list', []): True,
    (3675, 'tune_affiliate', 'offers', ["stat_clicks","stat_impressions","stat_payout","stat_conversions"]): True,
    (3256, 'tune_affiliate', 'offers', ["stat_clicks","stat_impressions","stat_payout","stat_conversions"]): True,
    (3368, 'advangelists', 'banners', ["impressions","conversions","completes","spend","clicks"]): True,
    (4439, 'advangelists', 'banners', ["impressions","conversions","completes","spend","clicks"]): True,
    (102, 'kenshoo_api_v3', 'custom_campaign_by_device', ["cost","validated_leads_revenue","m_install_revenue","appointment_revenue","purchase_revenue","online_aisle_revenue","orders_revenue","server_download_revenue","mobile_download_revenue","ecommerce_purchase_revenue","forrester_lead_revenue","subscription_revenue","impressions","clicks","revenue","conversions","conversions_revenue","d_v_start","d_enroll","m_install","appointment","online_aisle","orders","purchase","server_download","mobile_download","ecommerce_purchase","forrester_lead","subscription","validated_leads","cloud_dbaas","cloud_dbaas_revenue","white_pages","white_pages_revenue"]): True,
    (102, 'kenshoo_api_v3', 'keywords_by_device', ["conversions","potential_impressions","lost_is_rank","cost","impressions","revenue","clicks"]): True,
}
