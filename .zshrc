...
alias sandbox_second='ssh ubuntu@sandbox-second.srv.supl.biz'
alias monitor='ssh ubuntu@monitor.supl.biz'
alias db_prod='ssh ubuntu@db.srv.supl.biz'
alias hetzner='ssh root@116.203.85.209'
alias clickstream='source /home/anton/suplbiz-clickstream/venv/bin/activate; export DJANGO_SETTINGS_MODULE=project.settings; cd /home/anton/suplbiz-clickstream/clickstream; export PYTHONPATH=$PWD'
